...
class VistaInserisciStudente(QWidget):
    def __init__(self, controller, callback):
        super(VistaInserisciStudente, self).__init__()
        ...
        btn_ok.clicked.connect(self.add_studente)
        self.v_layout.addWidget(btn_ok)

        self.setLayout(self.v_layout)
        self.setWindowTitle("Nuovo Studente")
    ...
    def add_studente(self):
        ...
        if nome == "" or cognome == "" or cf == "" or indirizzo == "" or email == "" or telefono == "" or eta == "":
            ...
            self.controller.aggiungi_studente(Studente((nome+cognome).lower(), nome, cognome, cf, indirizzo, email, telefono, eta))
            self.callback()
            self.close()